    ...
    <div className="ml-[220px] pt-14 min-h-screen p-8">
      <div className="space-y-8">
        <div className="flex items-center gap-3">
          ...
          <p className="font-mono text-[13px] text-muted tracking-widest">LOADING EDITOR</p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="h-10 w-full bg-surface-container" />
                ))}
              </div>
            </div>
          </div>
          <div className="flex gap-3">
            <div className="h-12 w-32 bg-surface-container" />
            <div className="h-12 w-32 bg-surface-container" />
          </div>
        </div>
      </div>
