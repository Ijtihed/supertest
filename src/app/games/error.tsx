  ...
  return (
    <div className="ml-[220px] pt-14 min-h-screen p-8">
      <div className="max-w-md">
        <h2 className="font-headline font-bold text-2xl text-white mb-2">GAMES_ERROR</h2>
        <p className="font-mono text-[13px] text-muted tracking-widest mb-1">
          {error.digest ? `DIGEST: ${error.digest}` : "FAILED TO LOAD GAMES"}
        </p>
        <p className="font-body text-sm text-secondary mb-6">
          {error.message || "Something went wrong loading games."}
        </p>
